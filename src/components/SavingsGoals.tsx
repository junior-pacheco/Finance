          ...
          <div className="bg-zinc-900 w-full max-w-md p-6 rounded-xl shadow-lg relative text-white">
            ...
            <div className="space-y-4">
              ...
              <Input
                ...
                size="lg"
              />
               <h1 className="text-purple-500">Fecha límite</h1>
              <Input
                type="date"
                // label="Fecha límite"
              ...
              <div className="flex gap-2 mt-4">
                <Button fullWidth variant="bordered" onPress={() => setIsAddModalOpen(false)}>
                  Cancelar
                </Button>
                <Button
                  fullWidth
                  className="bg-purple-600 text-white rounded-md flex"
